...
(function ($) {
    class $habr_notes extends $mol_page {
        title() {
            return "Кросевошные заметки со сменой тем!";
        }
        plugins() {
            return [
                this.Theme()
        ...
        Input() {
            ...
            obj.enabled = () => this.i_have_can_mod();
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $habr_notes.prototype, "yard", null);
    __decorate([
        $mol_mem
    ], $habr_notes.prototype, "Theme", null);
    __decorate([
        $mol_mem
    ], $habr_notes.prototype, "Online", null);
    __decorate([
        $mol_mem
    ], $habr_notes.prototype, "Lighter", null);
    __decorate([
        $mol_mem
    ], $habr_notes.prototype, "text", null);
    __decorate([
        $mol_mem
    ], $habr_notes.prototype, "Input", null);
    $.$habr_notes = $habr_notes;
})($ || ($ = {}));
//habr/notes/-view.tree/view.tree.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $habr_notes extends $.$habr_notes {
            text(val) {
        ...
        __decorate([
            $mol_mem
        ], $habr_notes.prototype, "store", null);
        __decorate([
            $mol_mem
        ], $habr_notes.prototype, "current_note_id", null);
        __decorate([
            $mol_mem
        ], $habr_notes.prototype, "i_have_can_mod", null);
        $$.$habr_notes = $habr_notes;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//habr/notes/view.tree.ts
